...
export default function Navbar() {
  ...
  // Menü Linkleri (Hakkımızda eklendi)
  const menuItems = [
    { name: 'Ana Sayfa', path: '/' },
    { name: 'Menü', path: '/menu' },
    { name: 'Hakkımızda', path: '/hakkimizda' }, // BURASI EKLENDİ
        ...
        <div className="flex justify-between items-center h-20">
          ...
          <Link href="/" className="flex-shrink-0 flex items-center gap-2 group">
            <div 
              ...
              style={{ 
                backgroundColor: isTransparent ? 'rgba(255,255,255,0.2)' : '#DC2626',
                color: '#ffffff'
              }}
            >
            ...
            {menuItems.map((item) => {
              ...
              return (
                <Link 
                  ...
                  style={{ 
                    color: isActive ? '#DC2626' : textColor 
                  }}
                >
                  {item.name}
                </Link>
